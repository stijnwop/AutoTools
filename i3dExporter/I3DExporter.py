...
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Default'                                 , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':0,   'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Vehicle - Compound (Tractor, Truck)'     , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':2105410,   'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Vehicle - CompoundChild (Tractor, Truck)', 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':False, 'compoundChild':True,  'trigger':False, 'collision':True,  'collisionMask':2105410,   'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 0.001}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Combine - Compound'                      , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':4202626,   'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Combine - CompoundChild'                 , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':False, 'compoundChild':True,  'trigger':False, 'collision':True,  'collisionMask':4202626,   'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 0.001}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Fillable'                                , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':8397058,   'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Tool - Compound'                         , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':8194,      'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Tool - CompoundChild'                    , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':False, 'compoundChild':True,  'trigger':False, 'collision':True,  'collisionMask':8194,      'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 0.001}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Cutter'                                  , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':67121154,  'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Shovel'                                  , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':True,  'kinematic':False, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':8396802,   'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'TrafficVehicle'                          , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False,  'kinematic':True, 'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':2105442,   'clipDistance':350, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0, 'objectMask': 65535}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'FillVolume'                              , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,       'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':1, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'EmitterShape'                            , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,       'clipDistance':300, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':1, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'ShadowFocusBox'                          , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,       'clipDistance':150, 'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':1, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Trigger - Trailer/ShovelTip Trigger'     , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':True,  'compound':True,  'compoundChild':False, 'trigger':True,  'collision':True,  'collisionMask':1073741824,'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Trigger - ExactFillRootNode'             , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':True,  'compound':True,  'compoundChild':False, 'trigger':False, 'collision':True,  'collisionMask':1073741824,'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Trigger - AICollisionTrigger'            , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':True,  'compound':True,  'compoundChild':False, 'trigger':True,  'collision':True,  'collisionMask':1056768,   'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Trigger - TrafficCollisionTrigger'       , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':True,  'compound':True,  'compoundChild':False, 'trigger':True,  'collision':True,  'collisionMask':34611200,  'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Trigger - DynamicMountTrigger'           , 'isPhyiscObject':True,  'attributeValues':{'static':False, 'dynamic':False, 'kinematic':True,  'compound':True,  'compoundChild':False, 'trigger':True,  'collision':True,  'collisionMask':83886080,  'clipDistance':0,   'nonRenderable':True,  'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Lights -  Real'                          , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':75,  'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Lights -  Coronas'                       , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':200, 'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Lights -  Static'                        , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':35,  'nonRenderable':False, 'decalLayer': 1, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Decals - Small'                          , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':30,  'nonRenderable':False, 'decalLayer': 1, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Decals - Big'                            , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':50,  'nonRenderable':False, 'decalLayer': 1, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Exterior'                                , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':300, 'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Interior'                                , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':75,  'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'IndoorHud'                               , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':20,  'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'Mirrors'                                 , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':20,  'nonRenderable':False, 'decalLayer': 1, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'WindowsInside'                           , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':20,  'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
SETTINGS_VEHICLE_ATTRIBUTES.append({'name': 'WindowsOutside'                          , 'isPhyiscObject':False, 'attributeValues':{'static':False, 'dynamic':False, 'kinematic':False, 'compound':False, 'compoundChild':False, 'trigger':False, 'collision':False, 'collisionMask':255,      'clipDistance':200, 'nonRenderable':False, 'decalLayer': 0, 'cpuMesh':0, 'density': 1.0}})
...
SETTINGS_ATTRIBUTES['i3D_kinematic']            = {'type':TYPE_BOOL,  'defaultValue':False  , 'uiControl':UI_CONTROL_BOOL_KINEMATIC}
SETTINGS_ATTRIBUTES['i3D_compound']             = {'type':TYPE_BOOL,  'defaultValue':False  , 'uiControl':UI_CONTROL_BOOL_COMPOUND}
SETTINGS_ATTRIBUTES['i3D_compoundChild']        = {'type':TYPE_BOOL,  'defaultValue':False  , 'uiControl':UI_CONTROL_BOOL_COMPOUND_CHILD}
SETTINGS_ATTRIBUTES['i3D_collision']            = {'type':TYPE_BOOL,  'defaultValue':True   , 'uiControl':UI_CONTROL_BOOL_COLLISION}
SETTINGS_ATTRIBUTES['i3D_collisionMask']        = {'type':TYPE_INT,   'defaultValue':255    , 'uiControl':UI_CONTROL_INT_COLLISION_MASK}
SETTINGS_ATTRIBUTES['i3D_solverIterationCount'] = {'type':TYPE_INT,   'defaultValue':4      , 'uiControl':UI_CONTROL_INT_SOLVER_ITERATIONS}
SETTINGS_ATTRIBUTES['i3D_restitution']          = {'type':TYPE_FLOAT, 'defaultValue':0      , 'uiControl':UI_CONTROL_FLOAT_RESTITUTION}
SETTINGS_ATTRIBUTES['i3D_staticFriction']       = {'type':TYPE_FLOAT, 'defaultValue':0.5    , 'uiControl':UI_CONTROL_FLOAT_STATIC_FRICTION}
SETTINGS_ATTRIBUTES['i3D_dynamicFriction']      = {'type':TYPE_FLOAT, 'defaultValue':0.5    , 'uiControl':UI_CONTROL_FLOAT_DYNAMIC_FRICTION}
SETTINGS_ATTRIBUTES['i3D_linearDamping']        = {'type':TYPE_FLOAT, 'defaultValue':0.0    , 'uiControl':UI_CONTROL_FLOAT_LINEAR_DAMPING}
SETTINGS_ATTRIBUTES['i3D_angularDamping']       = {'type':TYPE_FLOAT, 'defaultValue':0.01   , 'uiControl':UI_CONTROL_FLOAT_ANGULAR_DAMPING}
...
SETTINGS_ATTRIBUTES['i3D_driveForceLimit']      = {'type':TYPE_FLOAT, 'defaultValue':100000 , 'uiControl':UI_CONTROL_FLOAT_DRIVE_FORCE_LIMIT}
...
SETTINGS_ATTRIBUTES['i3D_oc']                   = {'type':TYPE_BOOL,  'defaultValue':False  , 'uiControl':UI_CONTROL_BOOL_OCCLUSION_CULLING}
SETTINGS_ATTRIBUTES['i3D_nonRenderable']        = {'type':TYPE_BOOL,  'defaultValue':False  , 'uiControl':UI_CONTROL_BOOL_NON_RENDERABLE}
SETTINGS_ATTRIBUTES['i3D_clipDistance']         = {'type':TYPE_FLOAT, 'defaultValue':0      , 'uiControl':UI_CONTROL_FLOAT_CLIP_DISTANCE}
SETTINGS_ATTRIBUTES['i3D_objectMask']           = {'type':TYPE_INT,   'defaultValue':255    , 'uiControl':UI_CONTROL_INT_OBJECT_MASK}
SETTINGS_ATTRIBUTES['i3D_lightMask']            = {'type':TYPE_STRING,'defaultValue':'FFFF' , 'uiControl':UI_CONTROL_STRING_LIGHT_MASK}
...
SETTINGS_ATTRIBUTES['i3D_lod1']                 = {'type':TYPE_FLOAT, 'defaultValue':0      , 'uiControl':UI_CONTROL_FLOAT_CHILD_1_DISTANCE}
SETTINGS_ATTRIBUTES['i3D_lod2']                 = {'type':TYPE_FLOAT, 'defaultValue':0      , 'uiControl':UI_CONTROL_FLOAT_CHILD_2_DISTANCE}
SETTINGS_ATTRIBUTES['i3D_lod3']                 = {'type':TYPE_FLOAT, 'defaultValue':0      , 'uiControl':UI_CONTROL_FLOAT_CHILD_3_DISTANCE}
...
def I3DExportToFile(filename, ik, animation, shapes, nurbscurves, lights, cameras, userattributes, defaultcameras, particlesystems, exportBinaryFiles, ignoreBindPoses, normals, colors, texCoords, skinWeights, mergeGroups, verbose, exportSelection, relativePaths, template, floatEpsilon):
...
# TAB EXPORT
    ...
    cmds.checkBoxGrp(UI_CONTROL_EXPORT_4, parent=exportOptionsItems, height=28, numberOfCheckBoxes=2, v1=True,  v2=False, labelArray2=['Binary Files', 'Ignore Bind Poses'], cc=I3DSaveSettings )
    ...
    # errors
    errorFrame = cmds.frameLayout(UI_CONTROL_FRAME_ERRORS, parent=exportColums, label='Validation & Errors', cll=True, mh=0, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState)
    errorField = cmds.scrollField(UI_CONTROL_STRING_VALIDATION, parent=tabExport, wordWrap=False, editable=True)

    cmds.formLayout(tabExport, edit=True, attachForm=((exportColums, 'top', 1), (exportColums, 'left', 1), (exportColums, 'right', 1), (errorField, 'left', 2), (errorField, 'right', 2), (errorField, 'bottom', 2)), attachControl=((errorField, 'top', 0, exportColums)))
...
# TAB ATTRIBUTES
    ...
    I3DAddIntFieldElement(rigidBodyItems, 'Collision Mask', UI_CONTROL_INT_COLLISION_MASK, 255, '', width=MASK_FIELD_WIDTH)
    ...
    buttonLoad = cmds.button(parent=attributeButtonItems, label='Load', height=30, width=126, command=I3DLoadObjectAttributes)
    ...
    cmds.formLayout(tabAttributes, edit=True, attachForm=((loadedNodeFrame, 'top', 2), (loadedNodeFrame, 'left', 2), (loadedNodeFrame, 'right', 2),
                                                          ...
                                                          (attributesFrame, 'top', 95), (attributesFrame, 'left', 2), (attributesFrame, 'right', 2), (attributesFrame, 'bottom', 32),
...
# TAB TOOLS
    ...
    scrollToolsLayout = cmds.columnLayout('scrollToolsLayout', parent=scrollTools, adjustableColumn=True, columnOffset=('right', 1))

    # pivot tools
    pivotFrame = cmds.frameLayout(UI_CONTROL_FRAME_PIVOT, parent=scrollToolsLayout, label='Pivot-Tools', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonEqual = cmds.button(parent=pivotItems1, label='EqualizeWorldPivots',height=30, command=I3DAdjustWorldPivot, annotation='Adjusts the selected node pivots. Sets the pivot of the first node to the second node\'s pivot position')
    ...
    buttonToPivot = cmds.button(parent=pivotItems2, label='ManipulatorToPivot', height=30, command=I3DManipulatorToPivot, annotation='Sets the pivot of the node to the manipulator position')
    buttonToGroup = cmds.button(parent=pivotItems2, label='ManipulatorToGroup', height=30, command=I3DManipulatorToGroup, annotation='Creates a transform group based on current selection')
    ...
    freezeFrame = cmds.frameLayout(UI_CONTROL_FRAME_FREEZE, parent=scrollToolsLayout, label='Freeze Transformation', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonFreezeTrans = cmds.button(parent=freezeItems1, label='Freeze Translation', height=30, command=I3DFreezeTranslation, annotation='Freezes translation')
    buttonFreezeRot = cmds.button(parent=freezeItems1, label='Freeze Rotation',     height=30, command=I3DFreezeRotation, annotation='Freezes rotation')
    ...
    buttonFreezeScale = cmds.button(parent=freezeItems2, label='Freeze Scale', height=30, command=I3DFreezeScale, annotation='Freezes scale')
    buttonFreezeAll = cmds.button(parent=freezeItems2, label='Freeze All', height=30, command=I3DFreezeAll, annotation='Freezes translation, rotation and scale')
    ...
    # mesh tools
    meshFrame = cmds.frameLayout(UI_CONTROL_FRAME_MESH, parent=scrollToolsLayout, label='Mesh-Tools', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonDetachFaces = cmds.button(parent=meshItems1, label='DetachFaces', height=30, command=I3DDetachFaces, annotation='Detached the selcted faces from the node')
    buttonSetMirrorAxis = cmds.button(parent=meshItems1, label='SetMirrorAxis',     height=30, command=I3DSetupMirrorAxis, annotation='Sets axis of mirror')
    ...
    buttonAlignZ = cmds.button(parent=meshItems2, label='AlignZAxis', height=30, command=I3DAlignZAxis, annotation='Aligns the z-axis of the node against the selected second node')
    buttonAlignNegZ = cmds.button(parent=meshItems2, label='AlignNegativeZAxis', height=30, command=I3DAlignNegativeZAxis, annotation='Aligns the negative z-axis of the node against the selected second node')
    ...
    buttonRemoveNS = cmds.button(parent=meshItems3, label='Remove Namespace', height=30, command=I3DRemoveNameSpace, annotation='Removes obsolte namespaces')
    buttonZAxisToMani = cmds.button(parent=meshItems3, label='ZAxisToManipulator', height=30, command=I3DAlignZAxisToManipulator, annotation='Aligns the z-axis of the node against the selected manipulator')
    ...
    # Material tools
    materialFrame = cmds.frameLayout(UI_CONTROL_FRAME_MATERIAL, parent=scrollToolsLayout, label='Material-Tools', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonRemoveDuplicateMaterials = cmds.button(parent=materialItems1, label='Remove Duplicate Materials', height=30, command=I3DRemoveDuplicateMaterials, annotation='Removes duplicate materials')
    buttonRemoveDuplicateTextures = cmds.button(parent=materialItems1, label='Remove Duplicate Textures', height=30, command=I3DRemoveDuplicateTextures, annotation='Removes duplicate textures')

    cmds.formLayout(materialItems1, edit=True,
                                       attachPosition=((buttonRemoveDuplicateMaterials, 'left', 0, 0),   (buttonRemoveDuplicateMaterials, 'right', 5, 50),
                                                       (buttonRemoveDuplicateTextures, 'left', 0, 50),   (buttonRemoveDuplicateTextures, 'right', 0, 100)))

    materialItems2 = cmds.formLayout('meshItems2', parent=materialColumns)
    buttonMaterialRenamer = cmds.button(parent=materialItems2, label='Rename Materials', height=30, command=I3DMaterialRenamer, annotation='Renames materials based on GIANTS guidelines')
    buttonGetComponentShader = cmds.button(parent=materialItems2, label='Get Component Shader', height=30, command=I3DGetComponentShader, annotation='Gets the component shader')
    cmds.formLayout(materialItems2, edit=True,
                                       attachPosition=((buttonMaterialRenamer, 'left', 0, 0),   (buttonMaterialRenamer, 'right', 5, 50),
                                                       (buttonGetComponentShader, 'left', 0, 50),   (buttonGetComponentShader, 'right', 0, 100)))


    # uv tools
    uvFrame = cmds.frameLayout(UI_CONTROL_FRAME_UVS, parent=scrollToolsLayout, label='UV-Tools', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    textUVClean = cmds.button(parent=uvItems1, label='Cleanup UVs', height=30, command=I3DCleanupUVSet, annotation='Cleanup UVSets')
    ...
    # skeleton creation
    skeletonFrame = cmds.frameLayout(UI_CONTROL_FRAME_SKELETON, parent=scrollToolsLayout, label='Skeletons', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonCreate = cmds.button(parent=skeletonItems, label='Create', height=30, command=I3DCreateSkeleton, annotation='Create skeleton')
    ...
    # ui tools
    uiFrame = cmds.frameLayout(UI_CONTROL_FRAME_UI, parent=scrollToolsLayout, label='UV-Tools', cll=True, mh=2, mw=2, expandCommand=I3DSaveFrameState, collapseCommand=I3DSaveFrameState )
    ...
    buttonToggleVC = cmds.button(parent=uiItems1, label='Toggle ViewCube', height=30, command=I3DToggleViewCube, annotation='Turns the viewCube on/off')

    cmds.formLayout(uiItems1, edit=True,
                                       attachPosition=((buttonToggleVC, 'left', 0, 0), (buttonToggleVC, 'right', 5, 50)))

    cmds.formLayout(tabTools, edit=True, attachForm=((scrollTools, 'top', 0), (scrollTools, 'left', 0), (scrollTools, 'right', 0), (scrollTools, 'bottom', 0)))


# TAB SHADER
    tabShader = cmds.formLayout('TabShader', parent=tabs)

    shaderFolderFrame = cmds.frameLayout('shaderFolderFrame', parent=tabShader, label='Shaders Folder', cll=False, mh=2, mw=2)
    ...
    textFieldShaderFolder = cmds.textField(UI_CONTROL_STRING_SHADER_PATH, parent=shaderFolderItems, width=250, editable=False, cc=I3DSetShaderPath)
    ...
    menuShaders = cmds.optionMenu(UI_OPTIONS_PREDEFINED_SHADER_ATTRIBUTES, parent=shadersFrame, label='', changeCommand=I3DUpdateShaderUI)

    parameterFrame = cmds.frameLayout(UI_CONTROL_LAYOUT_PARAMETERS, parent=tabShader, label='Parameters', cll=False, mh=2, mw=2)
    ...
    texturesFrame = cmds.frameLayout(UI_CONTROL_LAYOUT_TEXTURES, parent=tabShader, label='Textures', cll=False, mh=2, mw=2, visible=True)
    ...
    variationsFrame = cmds.frameLayout(UI_CONTROL_LAYOUT_VARIATIONS, parent=tabShader, label='Variations', cll=False, mh=2, mw=2, visible=True)
    cmds.optionMenu(UI_CONTROL_MENU_VARIATIONS, parent=variationsFrame)

    buttonAdd = cmds.button(parent=tabShader, label='Add shader', height=30, command=I3DSetShader, annotation='Adds the shader to the selected material')

    cmds.formLayout(tabShader, edit=True, attachForm=((shaderFolderFrame, 'top', 2), (shaderFolderFrame, 'left', 2), (shaderFolderFrame, 'right', 2),
                                                      (shadersFrame, 'top', 50), (shadersFrame, 'left', 2), (shadersFrame, 'right', 2),
                                                      (parameterFrame, 'top', 100), (parameterFrame, 'left', 2), (parameterFrame, 'right', 2), (parameterFrame, 'bottom', 210),
...
def I3DUpdateXML(unused):
    ...
    for xmlFile in xmlFiles:
        ...
        for line in newLines:
            ...
            if len(re.findall('</vehicle>', line)) > 0:
                found = True
                break
        ...
        if found:
            ...
            I3DAddWarning('Could not find end tag "</vehicle>". Ignoring i3dMappings!')
...
def I3DAddI3dMapping(list, root):
    ...
    if not nodes is None:
        for node in nodes:
            ...
            if((nodeType == 'transform' or nodeType == 'joint') and node != 'top' and node != 'side' and node != 'front' and node != 'persp'):
                ...
                if xmlIdentifier != '':
                    ...
                    if not indexPath is None:
                        if xmlIdentifier in g_exportXMLIdentifiers:
                            I3DAddError(node + ' XML-Identifier "'+xmlIdentifier+'" already used for node "'+g_exportXMLIdentifiers[xmlIdentifier]+'"!')
                        else:
...
def I3DErrorCheck(unused):
    ...
    if errorCount == 0:
        if warningCount == 0:
            ...
            I3DAddMessage('Successfully finished error check ('+str(export_ObjectCount)+' objects) with ' + str(warningCount) + ' warnings')
    else:
        I3DAddMessage('Finished error check ('+str(export_ObjectCount)+' objects) with ' + str(errorCount) + ' errors and ' + str(warningCount) + ' warnings')
...
def I3DExportSaveAsDialog(exportSelection, clearErrors, path):
    ...
    errorCount += I3DExportToFile(str(outputFile), scenegraph, animation, shapes, shaders, lights, cameras, userattributes, defaultcameras, particlesystems, exportBinaryFiles, ignoreBindPoses, normals, colors, texCoords, skinWeigths, mergeGroups, verbose, exportSelection, relativePaths, templates, floatEpsilon)
    ...
    if errorCount == 0:
        if warningCount == 0:
            ...
            I3DAddMessage('Successfully finished export ('+str(export_ObjectCount)+' objects) with ' + str(warningCount) + ' warnings')
    else:
        I3DAddMessage('Finished export ('+str(export_ObjectCount)+' objects) with ' + str(errorCount) + ' errors and ' + str(warningCount) + ' warnings')
...
def I3DExportSaveWithoutUI( exportSelection = False):
    ...
    if(outputFile == ''):
        return outputFile
    I3DExportToFile(str(outputFile), ik, animation, shapes, nurbscurves, lights, cameras, userattributes, defaultcameras, particlesystems, exportBinaryFiles, ignoreBindPoses, normals, colors, texCoords, skinWeigths, mergeGroups, verbose, exportSelection, relativePaths, templates, floatEpsilon)
    return outputFile
...
def I3DCheckScenegraph():
    ...
    if export_PolyCount > MAX_POLYCOUNT:
        I3DAddWarning('Polycount '+str(export_PolyCount)+' is very high. This causes performance issues. Try to reduce polycount')
        errorCount = errorCount + 1

    if export_ObjectCount > MAX_OBJECTCOUNT:
        I3DAddWarning('Objectcount '+str(export_ObjectCount)+' is very high. This causes performance issues. Try to combine some objects')
        errorCount = errorCount + 1
    ...
    for mergeGroup, numSkinnedMergeJoints in g_exportNumSkinnedMergeJoints.iteritems():
        if numSkinnedMergeJoints > MAX_SKINNED_JOINTS:
            I3DAddWarning('MergeGroup '+str(mergeGroup)+' has '+str(numSkinnedMergeJoints)+' joints. Maximum number of joints is '+str(MAX_SKINNED_JOINTS)+'. Use an additional mergegroup!')
            errorCount = errorCount + 1

    for boundingVolume, isDefined in g_exportSkinnedMergeVolumes.iteritems():
        if not isDefined:
            I3DAddInfo('No bounding-volume defined for '+str(boundingVolume)+'. Automatically calculating bounding volume!')
...
def I3DCheckTransfromGroup(node):
    ...
    if(nodeType == NODETYPE_MESH and not isNonRenderable and mergeGroup == 0 and boundingVolume == '' and not I3DUtils.isCamera(node) and clipDistance == 0.0):
...
def I3DCheckMaterials(node):
    ...
    if not shapes is None:
        ...
        if not materials is None:
            ...
            if(len(materials) > 1):
                warningCount += 1
                nodeWarnings += '  (Warning) Node has '+str(len(materials))+' material assigned to it. This might cause performance issues. Consider splitting up the mesh (Help: Split meshes)\n'
            ...
            if mergeGroup > 0:
                ...
                if g_exportSkinnedMergeMaterials[mergeGroup]['material'] != materials[0]:
                    nodeWarnings += '  (Warning) Node has different material (Mergegroup_'+str(mergeGroup)+' - Basematerialnode: '+g_exportSkinnedMergeMaterials[mergeGroup]['node']+') assigned to it. This might cause performance issues. Consider using another mergegroup!\n'
                    warningCount += 1
...
def I3DCreateBaseVec(isHarvester):
    ...
    I3DCreateSkelNode("playerRightHandTarget", steeringWheel, True, [-0.188, 0.03, -0.022], ['-10.518deg', '-4.708deg', '51.12deg'])
    I3DCreateSkelNode("playerLeftHandTarget", steeringWheel, True, [0.189, 0.03, -0.023], ['-10.518deg', '-4.708deg', '-51.12deg'])
...
def I3DCreateLight(name, parent, coneAngle, intensity, dropOff, rgb, locatorScale=50, castShadowMap=False, depthMapBias=0.001, depthMapResolution=256):
...
def I3DUpdateShaderUI(selectedItemName):
    ...
    if 'parameters' in shaderInfo:
        for v in shaderInfo['parameters']:
            ...
            cmds.formLayout(layout, edit=True, attachForm=((checkbox, 'left', 0), (text, 'left', 20), (textField, 'left', 190), (textField, 'right', 0)))
    ...
    for shader in shaders:
        ...
        if not SETTINGS_SHADER_VARIATIONS is None:
            ...
            if not variation is None and variation != 'None':
                cmds.addAttr(dt='string', shortName='customShaderVariation', niceName='customShaderVariation', longName='customShaderVariation')
